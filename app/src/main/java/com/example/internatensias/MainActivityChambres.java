...
public class MainActivityChambres extends AppCompatActivity
{
    RecyclerView recview;
    myadapterChambre adapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_mainchambre);
        ...
        adapter=new myadapterChambre(options);
