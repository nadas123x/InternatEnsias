...
public class myadapter2 extends FirebaseRecyclerAdapter<modelProblem,myadapter2.myviewholder>
{
    public myadapter2(@NonNull FirebaseRecyclerOptions<modelProblem> options)
    {
        super(options);
    }
